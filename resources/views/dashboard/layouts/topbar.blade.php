<nav class="navbar navbar-expand-lg c-topbar py-0 mb-4">
   <button id="sidebarToggleTop" class="sidebar-toggler btn btn-link me-3" type="button"
   ...
   <ul class="navbar-nav flex-row align-items-center ms-auto">
       <li class="nav-item dropdown d-sm-none d-inline-block">
           <a class="nav-link" data-bs-toggle="dropdown" aria-expanded="false"><i
       ...
       <li class="nav-item dropdown avator-nav">
           <a class="nav-link" data-bs-toggle="dropdown" aria-expanded="false">
               <span class="text-sm d-none d-lg-inline-block me-2">John maclane</span>
