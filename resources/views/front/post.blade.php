    ...
    <x-slot name="breadcrumb">
        ...
        <div class="row my-3 my-lg-5 gx-lg-5">
            <div class="col-12 col-lg-8">
                <div class="post">
                    <figure class="figure">
                        <img src="{{ asset('storage/' . $post->featured_image) }}" class="figure-img img-fluid post__img"
                            alt="..." />
                    ...
                    <div class="post__info-container">
                        ...
                        <div class="d-flex justify-content-end justify-content-sm-between align-items-center flex-wrap">
                            ...
                            <span class="fw-bold post__date d-inline-block ms-3 mb-3 mb-sm-0"><i
                                    class="bi bi-calendar"></i> {{ $post->created_at->format('d M Y') }}</span>
